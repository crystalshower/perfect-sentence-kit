			...
			<form>
				<div>
					<div class="bg-[#252521] w-96 m-10 flex flex-col items-center justify-center">
						<div
							class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 bg-[#252525] border-gray-400"
						>
							<div class="p-6 space-y-4 md:space-y-6 sm:p-8">
								...
								<form class="space-y-4 md:space-y-6" method="POST" action="?/login" use:enhance>
									...
									<button
										type="submit"
										class="bg-blue-600 w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-2 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
										>Sign in</button
									>
